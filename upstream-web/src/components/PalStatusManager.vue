...
.passive-line { display: flex; align-items: center; gap: 7px; }
.passive-line i { display: inline-flex; min-width: 0; align-items: center; gap: 4px; overflow: hidden; color: var(--app-ink-secondary); font-size: 10px; font-style: normal; text-overflow: ellipsis; white-space: nowrap; }
.passive-line i::before { width: 6px; height: 6px; flex: 0 0 6px; background: var(--app-ink-muted); border-radius: 50%; content: ""; }
.passive-line i.is-negative::before { background: #b43f50; }
.passive-line i.is-gold::before { background: #b87922; }
.passive-line i.is-rainbow::before { background: conic-gradient(#d44c70, #8d61c5, #357fba, #2e9472, #c18a20, #d44c70); }
