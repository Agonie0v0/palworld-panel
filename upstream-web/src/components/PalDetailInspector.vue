...
const copy = computed(() => zh.value ? {
  ...
  work: "存档工作能力", workExplicitHint: "读取存档中该只帕鲁直接记录的工作等级", workBonusHint: "物种基础等级 + 存档个体加成 + 凝结等级加成", workBaseHint: "存档未记录个体加成，显示该物种的实际基础工作等级", workUnknownHint: "存档未提供工作能力数据", partner: "伙伴技能", levelSkills: "等级技能", drops: "掉落物",
  ...
  work: "Save work suitability", workExplicitHint: "Read directly from this Pal's saved work levels", workBonusHint: "Species base level plus saved individual and condensation bonuses", workBaseHint: "No individual bonus was persisted; showing this species' actual base work level", workUnknownHint: "The save does not provide work suitability data", partner: "Partner skill", levelSkills: "Level-up skills", drops: "Drops",
