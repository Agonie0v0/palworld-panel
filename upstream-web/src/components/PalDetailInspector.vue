...
.pal-detail-inspector__close { position: absolute; z-index: 3; top: 18px; right: 18px; display: grid; width: 44px; height: 44px; place-items: center; color: var(--app-ink); background: var(--app-surface-muted); border: 0; border-radius: 50%; cursor: pointer; font-size: 20px; }
...
.pal-detail-passives,.pal-detail-work { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); align-items: stretch; gap: 7px; }.pal-detail-passives :deep(.pal-passive-badge) { height: 100%; }.pal-detail-work :deep(.pal-work-badge) { min-width: 0; }
